                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.user_name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{old('username')}}" autocomplete="off" type="text" placeholder="User Name" id="user-name" name="username">
                                        @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="full" class="form-control-label">{{ __('Full Name') }}</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.password') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="password" placeholder="password" id="name" name="password" value="">
                                </div>
                            </div>
                        </div>
                    </div>
